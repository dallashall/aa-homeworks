...
ActiveRecord::Schema.define(version: 20170209083617) do
  ...
  add_index "responses", ["respondent_id", "answer_choice_id"], name: "index_responses_on_respondent_id_and_answer_choice_id"
